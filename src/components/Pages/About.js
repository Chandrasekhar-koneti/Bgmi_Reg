...
import abtimage from '../images/bgmi1.jpg'
...
const About=()=>{
    return(
                     ...
                     Lorem ipsum dolor, sit amet consectetur rebates.
                      ...
                      therefore, an obstacle to the duties of the debts receives the very great
                        ...
                        the fault, it is often one of us, however, have any! Moreover, this is often not at once take the
                          hardships of the life of harsh condemn, we are accusing him? Him whom something large cisterns.  
                </p>
            <br></br>
        <p>
        ...
        <marquee  behaviour='scroll'  bgcolor='yellow'><b>My webiste</b></marquee>
        {/* <Footer /> */}
        </>
    )
}
